"""Independent consistency checks for a generated dataset directory."""
...
def validate_dataset(data_dir: str | Path) -> list[str]:
    """Return a list of error strings; empty means the snapshot is consistent."""
