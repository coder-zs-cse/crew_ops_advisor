        ...
        for day in ctx.cover_days:
            ...
            steps = [
                ArithmeticStep(
                    ...
                    f"7 calendar days {(d - timedelta(days=6)).isoformat()} .. {d.isoformat()}",
                    base,
                    "h",
                ),
            ]
            ...
            steps.append(
                ArithmeticStep("Total vs limit", f"{base} + {added} = {total} vs 60.0", total, "h")
            )
            ...
            out.append(
                RuleVerdict(
                    ...
                    message=(
                        ...
                        if breached
                        else f"7-day duty {total}h of 60h ({round(60.0 - total, 2)}h headroom) on {d}"
                    ),
